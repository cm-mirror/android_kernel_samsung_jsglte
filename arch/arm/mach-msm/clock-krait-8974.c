...
#if defined(CONFIG_MACH_VIENNAEUR) || defined(CONFIG_MACH_FLTESKT) || defined(CONFIG_SEC_LOCALE_KOR_H) || defined(CONFIG_MACH_VIENNAKOR) || defined(CONFIG_MACH_KLTE_CHN) || defined(CONFIG_MACH_JSGLTE_CHN_CMCC)
	boost_uv=25000;
	enable_boost=1;
#endif
